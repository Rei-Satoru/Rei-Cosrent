                        ...
                        <a href="<?php echo e(url('/katalog_kostum?cat='. urlencode(strtolower($kategori->name)))); ?>" class="text-decoration-none text-dark">
                            <div class="card category-card h-100 rounded-xl border-0 shadow-sm">
                                ...
                                <div class="card-body py-2 px-3">
                                    <h5 class="fw-bold text-primary"><?php echo e($kategori->name); ?></h5>
                                    <p class="text-muted small mb-0"><?php echo e($kategori->description); ?></p>
                                </div>
                            </div>
                        </a>
                    </div>
                    ...
                    <div class="card profile-card rounded-xl border-0 shadow-lg p-4">
                        <div class="row g-0 align-items-center">
                            <div class="col-md-4 text-center p-3">
                                ...
                                <?php endif; ?>
                                <h4 class="fw-bold text-primary"><?php echo e(optional($profile)->name); ?></h4>
                                <p class="text-muted mb-0"><?php echo e(optional($profile)->title); ?></p>
                            </div>
                            <div class="col-md-8">
                                <div class="card-body">
                                    <h5 class="card-title fw-bold blue-title">Tentang Saya</h5>
                                    <p class="card-text text-muted"><?php echo nl2br(e(optional($profile)->vision)); ?></p>
                                </div>
                            </div>
                        </div>
                    </div>
                            ...
                            <ul class="list-group list-group-flush">
                                <li class="list-group-item d-flex align-items-center bg-transparent px-0">
                                    ...
                                    <div>
                                        ...
                                        <p class="mb-0 fw-bold"><?php echo e(optional($profile)->address); ?></p>
                                    </div>
                                </li>
                                <li class="list-group-item d-flex align-items-center bg-transparent px-0">
                                ...
                                <li class="list-group-item d-flex align-items-center bg-transparent px-0">
                                    ...
                                    <div>
                                        ...
                                        <p class="mb-0 fw-bold"><?php echo e(optional($profile)->email); ?></p>
                                    </div>
                                </li>
                            </ul>
                        </div>
...
<?php echo $__env->make('layouts.main', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\rc_laravel\resources\views/home.blade.php ENDPATH**/ ?>