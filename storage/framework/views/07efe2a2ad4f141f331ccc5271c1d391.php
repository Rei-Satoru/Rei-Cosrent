                            ...
                            <tr>
                                ...
                                <td class="d-none d-md-table-cell">
                                    <?php if(!empty($item->gambar)): ?>
                                        <button type="button" class="btn p-0 border-0 bg-transparent js-kostum-image-preview" data-image-src="<?php echo e(asset($item->gambar)); ?>" data-image-title="Gambar Kostum: <?php echo e($item->nama_kostum); ?>" aria-label="Lihat gambar kostum <?php echo e($item->nama_kostum); ?>">
                                            <img src="<?php echo e(asset($item->gambar)); ?>" alt="<?php echo e($item->nama_kostum); ?>" class="kostum-thumb" style="max-width:80px;">
                                        </button>
                                    <?php else: ?>
                                        ...
                                        <div class="modal-body">
                                            <div class="row g-3">
                                                <div class="col-md-5 text-center">
                                                    <?php if(!empty($item->gambar)): ?>
                                                        <button type="button" class="btn p-0 border-0 bg-transparent js-kostum-image-preview" data-image-src="<?php echo e(asset($item->gambar)); ?>" data-image-title="Gambar Kostum: <?php echo e($item->nama_kostum); ?>" aria-label="Lihat gambar kostum <?php echo e($item->nama_kostum); ?>">
                                                            <img src="<?php echo e(asset($item->gambar)); ?>" alt="Gambar Kostum" class="img-fluid rounded kostum-thumb" style="aspect-ratio:1/1;object-fit:cover;">
                                                        </button>
                                                    <?php else: ?>
                                            ...
                                            <div class="modal-body">
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <select name="ukuran_kostum" class="form-select" required>
                                                        ...
                                                        <?php $__currentLoopData = $ukuran; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $uk): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                            <option value="<?php echo e($uk); ?>" <?php if(strcasecmp(trim($uk), trim($selectedUkuran ?? '')) === 0): echo 'selected'; endif; ?>><?php echo e($uk); ?></option>
                                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                    </select>
                                                </div>
                                                <div class="mb-3">
