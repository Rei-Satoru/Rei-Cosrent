            ...
            <div class="card-body p-4">
                <div class="row g-4 align-items-center">
                    <div class="col-md-4 text-center">
                        ...
                        ?>
                        <?php if($adminPhoto): ?>
                            <img src="<?php echo e($adminPhoto); ?>" alt="Foto Pengurus" class="rounded-circle mb-3" style="width: 120px; height: 120px; object-fit: cover; border: 1px solid var(--bs-border-color);">
                        <?php else: ?>
