                        ...
                        <a href="<?php echo e(url('/katalog_kostum?cat='. urlencode(strtolower($kategori->name)))); ?>" class="text-decoration-none">
                            <div class="card category-card h-100 border-0">
                                <div style="padding:1rem;">
                                    <img src="<?php echo e(str_starts_with($kategori->image, 'http') ? $kategori->image : asset($kategori->image)); ?>" class="w-100" alt="<?php echo e($kategori->name); ?>">
                                </div>
                    ...
                    <div class="profile-card rounded-xl border-0 p-4">
                        <div class="row g-0 align-items-center">
                            <div class="col-md-4 text-center p-3">
                                ...
                                <?php endif; ?>
                                <h4 class="fw-bold"><?php echo e(optional($profile)->name); ?></h4>
