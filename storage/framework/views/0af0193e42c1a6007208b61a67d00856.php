    ...
    <style>
        ...
        .hero-section {
            ...
            background:
                ...
                url("<?php echo e(asset('assets/img/Header Pic.png')); ?>") center/cover no-repeat;
        ...
        <div class="container-fluid container">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav ms-auto mb-2 mb-lg-0 align-items-center">
                    <li class="nav-item"><a class="nav-link fw-semibold" href="<?php echo e(route('peraturan')); ?>">Aturan</a></li>
                    ...
                    <?php if(session('admin_logged_in')): ?>
                        <li class="nav-item dropdown ms-lg-3">
                            ...
                            <ul class="dropdown-menu dropdown-menu-end">
                                <li><a class="dropdown-item" href="<?php echo e(route('admin.profile')); ?>"><i class="bi bi-person-circle"></i> Profil Admin</a></li>
                    ...
                    <?php elseif(session('user_logged_in')): ?>
                        <li class="nav-item dropdown ms-lg-3">
                            ...
                            <ul class="dropdown-menu dropdown-menu-end">
                                <li><a class="dropdown-item" href="<?php echo e(route('user.profile')); ?>"><i class="bi bi-person-circle"></i> Profil User</a></li>
                    ...
                    <?php else: ?>
                        <li class="nav-item ms-lg-3"><a class="nav-link fw-semibold" href="<?php echo e(route('login')); ?>">Login</a></li>
                        <li class="nav-item dropdown ms-lg-3">
