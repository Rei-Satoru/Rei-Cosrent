...
<body data-bs-theme="light" class="<?php echo e(request()->routeIs('home') ? 'homepage' : ''); ?>">
                ...
                <ul class="navbar-nav ms-auto mb-2 mb-lg-0 align-items-center">
                    ...
                    <?php if(session('admin_logged_in')): ?>
                        <li class="nav-item ms-lg-3">
                            <a class="nav-link fw-semibold d-flex align-items-center gap-2 ak-nav-btn" href="<?php echo e(route('admin.profile')); ?>">
                    ...
                    <?php elseif(session('user_logged_in')): ?>
                        <li class="nav-item ms-lg-3">
                            <a class="nav-link fw-semibold d-flex align-items-center gap-2 ak-nav-btn" href="<?php echo e(route('user.profile')); ?>">
                    ...
                    <?php else: ?>
                        <li class="nav-item ms-lg-3"><a class="nav-link fw-semibold ak-nav-btn" href="<?php echo e(route('login')); ?>">Login</a></li>
                    <?php endif; ?>
                    <?php if(!session('admin_logged_in') && !session('user_logged_in')): ?>
                        <li class="nav-item ms-3 d-none d-lg-block">
                            <a class="btn ak-cta-btn" href="<?php echo e(route('register')); ?>">Register</a>
                        </li>
                        <li class="nav-item d-lg-none mt-2">
                            <a class="nav-link fw-semibold ak-nav-btn" href="<?php echo e(route('register')); ?>">Register</a>
                        </li>
                    <?php endif; ?>
                </ul>
            </div>
...
<?php /**PATH C:\laragon\www\rc_laravel\resources\views/layouts/main.blade.php ENDPATH**/ ?>