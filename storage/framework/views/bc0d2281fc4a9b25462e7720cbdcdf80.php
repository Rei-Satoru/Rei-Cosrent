    ...
    <div class="card shadow-sm">
        <div class="card-body">
            ...
            <div class="card shadow-sm mb-4">
                <div class="card-body">
                    <form method="GET" action="<?php echo e(route('admin.data-katalog')); ?>" class="row g-3 align-items-end">
                        <div class="col-md-4">
                            <input type="text" name="search" class="form-control" placeholder="Cari nama atau deskripsi..." value="<?php echo e($search ?? ''); ?>">
                        </div>
                        <div class="col-md-3">
                            <select name="kategori" class="form-select">
                                <option value="">Semua Kategori</option>
                                <?php $__currentLoopData = ($kategori_options ?? []); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $kat): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($kat); ?>" <?php echo e(($filter_kategori ?? '') === $kat ? 'selected' : ''); ?>><?php echo e($kat); ?></option>
                        ...
                        <div class="col-md-3">
                            <select name="sort" class="form-select">
                                ...
                                <option value="name_asc" <?php echo e(($sort ?? '') === 'name_asc' ? 'selected' : ''); ?>>Nama A - Z</option>
                                <option value="name_desc" <?php echo e(($sort ?? '') === 'name_desc' ? 'selected' : ''); ?>>Nama Z - A</option>
                            </select>
                        </div>
                            ...
                            <tr>
                                ...
                                <td class="d-none d-md-table-cell">
                                    <?php if(!empty($item->image)): ?>
                                        <button type="button" class="btn p-0 border-0 bg-transparent js-katalog-image-preview" data-image-src="<?php echo e(asset($item->image)); ?>" data-image-title="Gambar Katalog: <?php echo e($item->name); ?>" aria-label="Lihat gambar katalog <?php echo e($item->name); ?>">
                                            <img src="<?php echo e(asset($item->image)); ?>" alt="<?php echo e($item->name); ?>" class="katalog-thumb" style="max-width:80px;">
                                        </button>
                                    <?php else: ?>
