...
@section('title', 'Edit Pesanan - Rei Cosrent')
...
<section class="py-4">
    <div class="container">
        ...
        <div class="card shadow-sm border-0">
            ...
            <div class="card-body">
                <form method="POST" action="{{ route('user.pesanan.update', ['id' => $orderId]) }}" enctype="multipart/form-data">
                    @csrf
                    ...
                    <div class="mb-4">
                        ...
                        <div class="row g-3">
                            <div class="col-md-6">
                                ...
                                <input type="text" name="nama" class="form-control" value="{{ old('nama', $orderNama) }}" required>
                            </div>
                            <div class="col-md-6">
                                <label class="form-label">Nomor Telepon</label>
                                <input type="text" name="nomor_telepon" class="form-control" value="{{ old('nomor_telepon', $orderNomorTelepon) }}" required>
                            </div>
                            <div class="col-md-6">
                                <label class="form-label">Nomor Telepon Pihak Kedua</label>
                                <input type="text" name="nomor_telepon_2" class="form-control" value="{{ old('nomor_telepon_2', $orderNomorTelepon2) }}" required>
                            </div>
                            <div class="col-12">
                                <label class="form-label">Alamat Lengkap</label>
                                <textarea name="alamat" class="form-control" rows="3" required>{{ old('alamat', $orderAlamat) }}</textarea>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="mb-4">
                        ...
                        <div class="row g-3">
                            <div class="col-md-12">
                                ...
                                <input type="text" class="form-control" value="{{ $orderNamaKostum }}" readonly>
                            </div>
                            <div class="col-md-4">
                                <label class="form-label">Tanggal Pemakaian</label>
                                <input type="date" name="tanggal_pemakaian" class="form-control" value="{{ old('tanggal_pemakaian', $tanggalPemakaianValue) }}" required>
                            </div>
                            <div class="col-md-4">
                                <label class="form-label">Tanggal Pengembalian</label>
                                <input type="date" name="tanggal_pengembalian" class="form-control" value="{{ old('tanggal_pengembalian', $tanggalPengembalianValue) }}" required>
                            </div>
                            <div class="col-md-4">
                                <label class="form-label">Total Harga (Termasuk Ongkir)</label>
                                <input type="number" name="total_harga" class="form-control" value="{{ old('total_harga', $orderTotalHarga) }}" required min="0" step="0.01">
                            </div>
                            <div class="col-md-12">
                                <label class="form-label">Metode Pembayaran</label>
                                <div class="row g-3">
                                    @php $mp = old('metode_pembayaran', $orderMetodePembayaran); @endphp
                                    <div class="col-md-6">
                                        <div class="form-check">
                                            <input class="form-check-input" type="radio" name="metode_pembayaran" id="pembayaran_cod" value="COD" {{ $mp === 'COD' ? 'checked' : '' }} required>
                                            <label class="form-check-label" for="pembayaran_cod">COD (Cash On Delivery)</label>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-check">
                                            <input class="form-check-input" type="radio" name="metode_pembayaran" id="pembayaran_dana" value="Dana" {{ $mp === 'Dana' ? 'checked' : '' }} required>
                                            <label class="form-check-label" for="pembayaran_dana">Dana</label>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-check">
                                            <input class="form-check-input" type="radio" name="metode_pembayaran" id="pembayaran_gopay" value="GoPay" {{ $mp === 'GoPay' ? 'checked' : '' }} required>
                                            <label class="form-check-label" for="pembayaran_gopay">GoPay</label>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-check">
                                            <input class="form-check-input" type="radio" name="metode_pembayaran" id="pembayaran_shopeepay" value="ShopeePay" {{ $mp === 'ShopeePay' ? 'checked' : '' }} required>
                                            <label class="form-check-label" for="pembayaran_shopeepay">ShopeePay</label>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-check">
                                            <input class="form-check-input" type="radio" name="metode_pembayaran" id="pembayaran_qris" value="QRIS" {{ $mp === 'QRIS' ? 'checked' : '' }} required>
                                            <label class="form-check-label" for="pembayaran_qris">QRIS</label>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-check">
                                            <input class="form-check-input" type="radio" name="metode_pembayaran" id="pembayaran_transfer" value="Transfer Bank" {{ $mp === 'Transfer Bank' ? 'checked' : '' }} required>
                    ...
                    <div class="mb-4">
                        ...
                        <div class="row g-3">
                            <div class="col-md-12">
                                ...
                                @php $kid = old('kartu_identitas', $orderKartuIdentitas); @endphp
                                <div class="row g-3">
                                    <div class="col-md-6">
                                        <div class="form-check">
                                            <input class="form-check-input" type="radio" name="kartu_identitas" id="identitas_pelajar" value="Kartu Pelajar" {{ $kid === 'Kartu Pelajar' ? 'checked' : '' }} onchange="toggleLainnyaInput()" required>
                                            <label class="form-check-label" for="identitas_pelajar">Kartu Pelajar</label>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-check">
                                            <input class="form-check-input" type="radio" name="kartu_identitas" id="identitas_kia" value="KIA" {{ $kid === 'KIA' ? 'checked' : '' }} onchange="toggleLainnyaInput()" required>
                                            <label class="form-check-label" for="identitas_kia">KIA (Kartu Identitas Anak)</label>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-check">
                                            <input class="form-check-input" type="radio" name="kartu_identitas" id="identitas_ktm" value="KTM" {{ $kid === 'KTM' ? 'checked' : '' }} onchange="toggleLainnyaInput()" required>
                                            <label class="form-check-label" for="identitas_ktm">KTM (Kartu Tanda Mahasiswa)</label>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-check">
                                            <input class="form-check-input" type="radio" name="kartu_identitas" id="identitas_ktp" value="KTP" {{ $kid === 'KTP' ? 'checked' : '' }} onchange="toggleLainnyaInput()" required>
                                            <label class="form-check-label" for="identitas_ktp">KTP (Kartu Tanda Penduduk)</label>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-check">
                                            <input class="form-check-input" type="radio" name="kartu_identitas" id="identitas_sim" value="SIM" {{ $kid === 'SIM' ? 'checked' : '' }} onchange="toggleLainnyaInput()" required>
                                            <label class="form-check-label" for="identitas_sim">SIM (Surat Izin Mengemudi)</label>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-check">
                                            <input class="form-check-input" type="radio" name="kartu_identitas" id="identitas_lainnya" value="Lainnya" {{ $kid && !in_array($kid, ['Kartu Pelajar','KIA','KTM','KTP','SIM']) ? 'checked' : '' }} onchange="toggleLainnyaInput()" required>
                                ...
                                <div id="identitas_lainnya_input" style="display: none; margin-top: 1rem;">
                                    <input type="text" name="kartu_identitas_lainnya" class="form-control" placeholder="Sebutkan jenis identitas lainnya..." value="{{ in_array($kid, ['Kartu Pelajar','KIA','KTM','KTP','SIM']) ? '' : $kid }}">
                                </div>
                            </div>
                            <div class="col-md-6">
...
3. Menerima Konsekuensi</p>
                    ...
                    <div class="mt-2">
                        ...
                        <a href="{{ route('user.pesanan') }}" class="btn btn-secondary">
