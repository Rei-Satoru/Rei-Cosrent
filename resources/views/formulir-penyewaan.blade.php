            ...
            <div class="kostum-info">
                <div class="row">
                    <div class="col-md-3 text-center">
                        ...
                        @endphp
                        @if($src)
                            <img src="{{ $src }}" alt="{{ $kostum->nama_kostum }}" class="img-fluid rounded" style="max-width: 200px;">
                        @else
                            <img src="{{ asset('assets/img/no-image.png') }}" alt="Tidak ada gambar" class="img-fluid rounded" style="max-width: 200px;">
                        @endif
                    </div>
                    <div class="col-md-9">
            ...
            <div class="form-section">
                ...
                <div class="row g-3">
                    <div class="col-md-6">
                        ...
                        <input type="text" name="nama" class="form-control" value="{{ old('nama', session('user_logged_in') ? (App\Models\User::find(session('user_id'))->nick_name ?? '') : '') }}" required placeholder="Masukkan nama lengkap sesuai dengan identitas" autocomplete="off">
                    </div>
                    <div class="col-md-6">
                        <label class="form-label required-label">Email</label>
                        @if(session('user_logged_in'))
                            <input type="email" name="email" class="form-control" value="{{ old('email', session('user_email')) }}" required autocomplete="off">
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="text" name="nomor_telepon" class="form-control" value="{{ old('nomor_telepon', session('user_logged_in') ? (App\Models\User::find(session('user_id'))->nomor_telepon ?? '') : '') }}" required placeholder="08xxx" autocomplete="off">
                    </div>
                    <div class="col-md-6">
                    ...
                    <div class="col-12">
                        ...
                        <textarea name="alamat" class="form-control" rows="3" required placeholder="Masukkan alamat pengambilan/penerimaan dengan lengkap" autocomplete="off">{{ old('alamat', session('user_logged_in') ? (App\Models\User::find(session('user_id'))->alamat ?? '') : '') }}</textarea>
                    </div>
                </div>
            </div>
            ...
            <div class="form-section">
                ...
                <div class="row g-3">
                    <div class="col-md-12">
                        ...
                        <input type="text" name="nama_kostum" class="form-control" value="{{ $kostum->nama_kostum }}" readonly required>
                    </div>
                    <div class="col-md-4">
                        <label class="form-label required-label">Tanggal Pemakaian</label>
                        <input type="date" name="tanggal_pemakaian" class="form-control" value="{{ old('tanggal_pemakaian') }}" required>
                    </div>
                    <div class="col-md-4">
                        <label class="form-label required-label">Tanggal Pengembalian</label>
                        <input type="date" name="tanggal_pengembalian" class="form-control" value="{{ old('tanggal_pengembalian') }}" required>
                    </div>
                    <div class="col-md-4">
                        <label class="form-label required-label">Total Harga (Termasuk Ongkir)</label>
                        <input type="number" name="total_harga" class="form-control" value="{{ old('total_harga') }}" required min="0" step="0.01" placeholder="Masukkan total harga">
                    </div>
                    <div class="col-md-12">
                        ...
                        <div class="row g-3">
                            <div class="col-12 col-md-4">
                                <div class="form-check">
                                    <input class="form-check-input" type="radio" name="metode_pembayaran" id="pembayaran_dana" value="Dana" {{ old('metode_pembayaran') === 'Dana' ? 'checked' : '' }} required>
                            ...
                            <div class="col-12 col-md-4">
                                <div class="form-check">
                                    <input class="form-check-input" type="radio" name="metode_pembayaran" id="pembayaran_transfer" value="Transfer Bank" {{ old('metode_pembayaran') === 'Transfer Bank' ? 'checked' : '' }} required>
                ...
                <div class="row g-3">
                    <div class="col-md-12">
                        ...
                        <div class="row g-3">
                            <div class="col-md-6">
                                <div class="form-check">
                                    <input class="form-check-input" type="radio" name="kartu_identitas" id="identitas_pelajar" value="Kartu Pelajar" {{ old('kartu_identitas') === 'Kartu Pelajar' ? 'checked' : '' }} onchange="toggleLainnyaInput()" required>
                            ...
                            <div class="col-md-6">
                                <div class="form-check">
                                    <input class="form-check-input" type="radio" name="kartu_identitas" id="identitas_kia" value="KIA" {{ old('kartu_identitas') === 'KIA' ? 'checked' : '' }} onchange="toggleLainnyaInput()" required>
                            ...
                            <div class="col-md-6">
                                <div class="form-check">
                                    <input class="form-check-input" type="radio" name="kartu_identitas" id="identitas_ktm" value="KTM" {{ old('kartu_identitas') === 'KTM' ? 'checked' : '' }} onchange="toggleLainnyaInput()" required>
                            ...
                            <div class="col-md-6">
                                <div class="form-check">
                                    <input class="form-check-input" type="radio" name="kartu_identitas" id="identitas_ktp" value="KTP" {{ old('kartu_identitas') === 'KTP' ? 'checked' : '' }} onchange="toggleLainnyaInput()" required>
                            ...
                            <div class="col-md-6">
                                <div class="form-check">
                                    <input class="form-check-input" type="radio" name="kartu_identitas" id="identitas_sim" value="SIM" {{ old('kartu_identitas') === 'SIM' ? 'checked' : '' }} onchange="toggleLainnyaInput()" required>
                            ...
                            <div class="col-md-6">
                                <div class="form-check">
                                    <input class="form-check-input" type="radio" name="kartu_identitas" id="identitas_lainnya" value="Lainnya" {{ old('kartu_identitas') === 'Lainnya' || (old('kartu_identitas') && !in_array(old('kartu_identitas'), ['Kartu Pelajar', 'KIA', 'KTM', 'KTP', 'SIM'])) ? 'checked' : '' }} onchange="toggleLainnyaInput()" required>
                        ...
                        <div id="identitas_lainnya_input" style="display: none; margin-top: 1rem;">
                            <input type="text" name="kartu_identitas_lainnya" class="form-control" placeholder="Sebutkan jenis identitas lainnya..." value="{{ old('kartu_identitas_lainnya') }}">
                        </div>
                    </div>
                    <div class="col-md-4">
