                ...
                <div class="dashboard-hero admin-surface-card h-100 mb-0">
                    <div class="d-flex flex-column h-100">
                        ...
                        <div class="hero-profile-summary mt-auto">
                            @if($adminPhoto)
                                <img src="{{ $adminPhoto }}" alt="Foto Admin" class="hero-profile-photo">
                            @else
                            ...
                            @endif
                            <div>
                                <div class="hero-profile-name">{{ $profileName }}</div>
                                <div class="hero-profile-title">{{ $profileTitle }}</div>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="col-lg-4">
                <div class="admin-surface-card h-100 p-4 d-flex flex-column justify-content-between">
                    ...
                    <div class="d-grid gap-2">
                        ...
                        <a href="{{ route('admin.profile-contact') }}" class="btn btn-sm btn-secondary quick-action-btn w-100 text-start">
                            <i class="bi bi-pencil-square me-2"></i> Profil Admin
                        </a>
                        <a href="{{ route('admin.logout') }}" class="btn btn-sm btn-secondary quick-action-btn w-100 text-start">
                ...
                <table class="stats-table w-100">
                    ...
                    <tbody>
                        @forelse($latest_orders as $order)
                            <tr data-created-at="{{ $order->created_at ? $order->created_at->format('Y-m-d H:i:s') : '' }}" data-tanggal-pemakaian="{{ $order->tanggal_pemakaian ? \Carbon\Carbon::parse($order->tanggal_pemakaian)->format('Y-m-d') : '' }}">
                                <td>{{ $order->nama }}</td>
                                ...
                                <td>
                                    <a href="{{ route('admin.data-pesanan', ['open_detail' => $order->id]) }}" class="text-primary text-decoration-none small">
