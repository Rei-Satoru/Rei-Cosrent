    ...
    <div class="container">
            ...
            <div class="card-body p-4">
                <div class="d-flex align-items-center">
                    <div>
                        ...
                        @if($profile_contact)
                            <small class="text-primary">{{ $profile_contact->title }}</small>
                        @endif
                    </div>
                </div>
            </div>
        ...
        <div class="d-flex align-items-center justify-content-between mb-3">
            ...
            <div class="d-grid d-sm-flex align-items-center gap-2 w-100" style="max-width: 420px;">
                <a href="{{ route('admin.profile-contact') }}" class="btn btn-outline-primary"><i class="bi bi-pencil-square"></i> Kelola Profil</a>
                <a href="{{ route('admin.logout') }}" class="btn btn-danger"><i class="bi bi-box-arrow-right"></i> Logout</a>
            </div>
        </div>
            ...
            <div class="card-body p-4">
                <div class="row g-4 align-items-center">
                    <div class="col-md-4 text-center">
                        ...
                        @endif
                        <h5 class="fw-bold mb-0">{{ $profileName }}</h5>
                        <p class="text-primary mb-2">{{ $profileTitle }}</p>
                    ...
                    <div class="col-md-8">
                        <div class="mb-3">
                            ...
                            <div class="p-3 rounded bg-body-tertiary">
                                <span style="color: var(--bs-body-color);">{{ $profileVision }}</span>
                            </div>
                        </div>
                            ...
                            <div class="col-md-6">
                                <div class="d-flex align-items-start">
                                    ...
                                    <div>
                                        ...
                                        <span class="fw-semibold">{{ $profileAddress }}</span>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="d-flex align-items-start">
                                    ...
                                    <div>
                                        ...
                                        <span class="fw-semibold">{{ $profilePhone }}</span>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="d-flex align-items-start">
                                    ...
                                    <div>
                                        ...
                                        <span class="fw-semibold">{{ $profileEmail }}</span>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="d-flex align-items-start">
                                    ...
                                    <div>
                                        ...
                                        <span class="fw-semibold">{{ $profile_contact ? $profile_contact->name : (auth()->user()->name ?? 'Admin') }}</span>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="p-3 rounded stat-card bg-body-tertiary">
                            <div class="d-flex justify-content-between align-items-center">
                                <div>
                                    ...
                                    <div class="stat-number">{{ $katalog_count }}</div>
                                </div>
                        ...
                        <div class="p-3 rounded stat-card bg-body-tertiary">
                            <div class="d-flex justify-content-between align-items-center">
                                <div>
                                    ...
                                    <div class="stat-number">{{ $kostum_count }}</div>
                                </div>
                        ...
                        <div class="p-3 rounded stat-card bg-body-tertiary">
                            <div class="d-flex justify-content-between align-items-center">
                                <div>
                                    ...
                                    <div class="stat-number">{{ $denda_count }}</div>
                                </div>
                        ...
                        <div class="p-3 rounded stat-card bg-body-tertiary">
                            <div class="d-flex justify-content-between align-items-center">
                                <div>
                                    ...
                                    <div class="stat-number">{{ $ulasan_count }}</div>
                                </div>
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        ...
        async function loadStats(period = 'week') {
            try {
                const res = await fetch(`{{ url('/admin/stats') }}?period=${period}`, { headers: { 'Accept': 'application/json' } });
