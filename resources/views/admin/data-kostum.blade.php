                            ...
                            <tr>
                                ...
                                <td>
                                    @if(!empty($item->gambar))
                                        <img src="/storage/{{ basename($item->gambar) }}" alt="{{ $item->nama_kostum }}" style="max-width:80px;">
                                    @else
                                        ...
                                        <div class="modal-body">
                                            <div class="row g-3">
                                                <div class="col-md-5 text-center">
                                                    @if(!empty($item->gambar))
                                                        <img src="/storage/{{ basename($item->gambar) }}" alt="Gambar Kostum" class="img-fluid rounded" style="aspect-ratio:1/1;object-fit:cover;">
                                                    @else
