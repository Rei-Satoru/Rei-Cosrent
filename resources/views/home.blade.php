                        ...
                        <div class="row g-0 align-items-center">
                            <div class="col-md-4 text-center p-3">
                                @if($profile && $profile->photo)
                                    <img src="{{ asset('storage/' . $profile->photo) }}" class="img-fluid rounded-circle border border-primary border-4 mb-3" alt="Foto Pengurus" style="width: 150px; height: 150px; object-fit: cover;">
                                @else
                                    <div class="mb-3">
